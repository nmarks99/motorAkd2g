                        ...
                        0, 0) // Default priority and stack size
{
    ...
    if (status) {
        ...
        "%s: cannot connect to AKD2G motor controller\n",
        functionName);
    }
...
{
    AKD2GMotorController *pAKD2GMotorController = new AKD2GMotorController(portName, AKD2GMotorPortName, numAxes,
...
/// Note: the following constructor needs to be modified to accept the stepSize argument if AKD2GMotorCreateAxis
...
AKD2GMotorAxis::AKD2GMotorAxis(AKD2GMotorController *pC, int axisNo) : asynMotorAxis(pC, axisNo), pC_(pC)
{
    ...
    asynPrint(
        pasynUser_,
        ASYN_REASON_SIGNAL,
        "AKD2GMotorAxis created with axis index %d\n",
        axisIndex_
    );
...
/// \brief Move the axis
asynStatus AKD2GMotorAxis::move(double position, int relative, double min_velocity, double max_velocity, double acceleration) {
    return asynSuccess;
}
...
static const iocshArg * const AKD2GMotorCreateControllerArgs[] = {&AKD2GMotorCreateControllerArg0,
                                                             &AKD2GMotorCreateControllerArg1,
                                                             &AKD2GMotorCreateControllerArg2,
                                                             &AKD2GMotorCreateControllerArg3,
                                                             &AKD2GMotorCreateControllerArg4};
static const iocshFuncDef AKD2GMotorCreateControllerDef = {"AKD2GMotorCreateController", 5, AKD2GMotorCreateControllerArgs};
